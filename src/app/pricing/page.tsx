  ...
  return (
    <main className="flex flex-col items-center justify-center gap-8 mt-4 mb-8 sm:mt-16 p-4 pb-0">
      <div className="flex gap-4 flex-col items-center">
        <h1 className="text-5xl text-blue-900 font-bold">Services & Pricing</h1>
        <h2 className="text-2xl text-blue-900 font-bold max-w-[450px] text-center">Discover how we make property management easy and stress-free.</h2>
