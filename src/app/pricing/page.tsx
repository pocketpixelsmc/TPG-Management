    ...
    <main className="flex flex-col items-center justify-center gap-8 mt-4 p-4 pb-0 sm:mt-16">
      <div className="flex gap-4 flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link href="/services" className="inline-block bg-blue-900 px-8 py-3 text-white font-medium hover:bg-opacity-90 transition-colors rounded-lg">
            WORK WITH US
          </Link>
          <Link href="/owner-faqs" className="inline-block bg-blue-900 px-8 py-3 text-white font-medium hover:bg-opacity-90 transition-colors rounded-lg">
            Owner FAQs
          </Link>
        </div>
      </div>
