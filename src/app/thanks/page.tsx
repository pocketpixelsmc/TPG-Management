export default function Home() {
  return (
    <main className=" flex flex-col items-center justify-center">
      <div className="flex flex-col gap-2 mt-4 mb-8 sm:mt-16 p-4">
          <p className="text-5xl text-blue-900 font-bold mb-6">Thank You for Your Submission!</p>
          ...
          <p className="text-xl max-w-[838px] mb-3">Thank you for trusting TPG Management. We’re excited to possibly work with you!</p>
      </div>
    </main>
  );
}