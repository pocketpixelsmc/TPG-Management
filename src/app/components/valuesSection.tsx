      ...
      <div className="mt-12 border-t border-gray-200 p-6">
        <div className="flex flex-col md:flex-row items-start gap-8 justify-start">
          <div className="md:w-1/2 flex flex-col items-end">
            ...
            <p className="text-center text-sm mt-2 text-blue-950">Sample Owner&apos;s Portal Home Screen</p>
          </div>
          <div className="md:w-1/2">
            ...
            <div className="bg-white shadow-md rounded-lg p-4 border border-gray-200 mb-6">
              <ul className="list-disc pl-5 space-y-2 text-blue-950">
      ...
      <div className="mt-12 border-t border-gray-200 p-6">
        <div className="flex flex-col md:flex-row items-start gap-8 justify-start">
          <div className="md:w-1/2 flex flex-col items-end">
            ...
            <p className="text-center text-sm mt-2 text-blue-950">Sample Screening Process</p>
          </div>
          <div className="md:w-1/2">
