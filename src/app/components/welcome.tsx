    ...
    <section className="flex flex-col content-center justify-center max-w-full lg:flex-row gap-4 lg:gap-16 text-blue-900 m-4">
      <div className="flex flex-col items-start justify-center lg:max-w-[500px] text-left">
        ...
        <p className="text-sm xl:text-lg mb-6">
          We provide premier property management services across Monmouth, Middlesex, Union, Ocean, Essex, Bergen, Somerset, and Hudson counties.
        ...
        <Link href={"/contact"} className="flex w-full flex-col justify-center items-center">
          <button className="bg-blue-900 text-white p-2 px-6 md:px-8 md:p-4 md:self-start rounded-lg transition-all hover:bg-blue-700" onClick={() => sendGAEvent({ event: "Home Page B1 Clicked", value: "Learn More About Our Services"})}>
