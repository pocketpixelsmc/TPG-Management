    ...
    >
      ...
      <div className="w-full p-4">
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="space-y-2">
              {[
                ...
                { href: "https://instagram.com/tpgmanage", icon: "insta.png", label: "Instagram" }, // Added Instagram link
                { href: "https://facebook.com/tpgmanage", icon: "fb.png", label: "Facebook" }, // Added Facebook link
        ...
        <address className="border-t border-gray-700 pt-8 text-center not-italic">
          ...
          <div className="mt-8">
            <h3 className="text-xl font-semibold text-white mb-6">972 Broad St, Suite 300 Newark, NJ 07102</h3>
            ...
            <ul className="flex flex-wrap justify-center gap-8" role="list">
              {["Monmouth", "Middlesex", "Union", "Somerset", "Essex", "Hudson", "Bergen", "Passaic"].map((area) => (
