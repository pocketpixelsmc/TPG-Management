...
const headerVariants = cva("text-blue-900 font-bold leading-tight p-2 px-8 mb-4 w-screen text-center", {
  variants: {
    variant: {
      ...
      midBig: "text-2xl sm:text-3xl lg:text-6xl",
    },
  },
  defaultVariants: {
    variant: "noBg",
...
export default function H2({ children, className, variant, ...props }: HeaderProps) {
  return (
    <h2 className={headerVariants({ variant, className })} {...props}>
      {children}
    </h2>
  );
}
