...
export default function Navbar() {
    ...
    return (
        <>
            <nav className={`text-blue-900 py-1 mt-[10px] flex flex-col gap-2 text-xs sm:text-sm sticky top-0 z-10 transition-all duration-300 pb-2`} style={{ backgroundColor: showBackground ? "#e2e8f0" : undefined }}>
                <div className="flex flex-row justify-around items-center mt-4">
                    ...
                    <div className={`flex flex-row gap-3 justify-center items-center px-2 font-normal`}>
                        <Link href="/">
                            <button className="m-2 lg:text-3xl md:text-2xl sm:text-xs text-xs">
